...
import ca.tutic.site.configs.JacksonConfig__BeanDefinitions;
import ca.tutic.site.configs.LocaleConfig__BeanDefinitions;
import ca.tutic.site.configs.SecretsConfig__BeanDefinitions;
import ca.tutic.site.services.EmailService__BeanDefinitions;
import ca.tutic.site.services.StaticService__BeanDefinitions;
 ...
 */
public class SiteApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("siteApplication", SiteApplication__BeanDefinitions.getSiteApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("siteController", SiteController__BeanDefinitions.getSiteControllerBeanDefinition());
    beanFactory.registerBeanDefinition("jacksonConfig", JacksonConfig__BeanDefinitions.getJacksonConfigBeanDefinition());
    beanFactory.registerBeanDefinition("localeConfig", LocaleConfig__BeanDefinitions.getLocaleConfigBeanDefinition());
    beanFactory.registerBeanDefinition("secretsConfig", SecretsConfig__BeanDefinitions.getSecretsConfigBeanDefinition());
    beanFactory.registerBeanDefinition("emailService", EmailService__BeanDefinitions.getEmailServiceBeanDefinition());
    beanFactory.registerBeanDefinition("staticService", StaticService__BeanDefinitions.getStaticServiceBeanDefinition());
    beanFactory.registerBeanDefinition("objectMapper", JacksonConfig__BeanDefinitions.getObjectMapperBeanDefinition());
    beanFactory.registerBeanDefinition("messageSource", LocaleConfig__BeanDefinitions.getMessageSourceBeanDefinition());
    beanFactory.registerBeanDefinition("localeResolver", LocaleConfig__BeanDefinitions.getLocaleResolverBeanDefinition());
    beanFactory.registerBeanDefinition("localeChangeInterceptor", LocaleConfig__BeanDefinitions.getLocaleChangeInterceptorBeanDefinition());
